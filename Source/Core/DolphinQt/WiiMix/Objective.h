...
public:
  ...
  #define OBJECTIVE_REVIEW_ID "id"
  #define OBJECTIVE_REVIEW_OBJECTIVE_ID "objective_id"
  #define OBJECTIVE_REVIEW_PLAYER_ID "player_id"
  #define RESOLVED "resolved"
  #define IMPOSSIBLE "impossible"
  #define REVIEW "review"
  #define OBJECTIVE_REVIEW_TITLE "title"
  #define OBJECTIVE_REVIEW_RETROACHIEVEMENTS_GAME_ID "retroachievements_game_id"
  #define OBJECTIVE_REVIEW_GAME_ID "game_id"
  #define OBJECTIVE_REVIEW_ACHIEVEMENT_ID "achievement_id"
  #define OBJECTIVE_REVIEW_OBJECTIVE_TYPES "objective_types"
  #define OBJECTIVE_REVIEW_NUM_PLAYERS "num_players"
  #define OBJECTIVE_REVIEW_MULTIPLAYER_MODE "multiplayer_mode"
  #define OBJECTIVE_REVIEW_DESCRIPTION "description"
  #define OBJECTIVE_REVIEW_GAME_GENRES "game_genres"
  #define OBJECTIVE_REVIEW_DIFFICULTY "difficulty"
  #define OBJECTIVE_REVIEW_TIME "time"
