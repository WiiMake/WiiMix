...
constexpr std::array<const char*, NUM_HOTKEYS> s_hotkey_labels{{
    ...
    // _trans("Swap Game Slot 1"),
    // _trans("Swap Game Slot 2"),
    // _trans("Swap Game Slot 3"),
    // _trans("Swap Game Slot 4"),
    // _trans("Swap Game Slot 5"),
    // _trans("Swap Game Slot 6"),
    // _trans("Swap Game Slot 7"),
    // _trans("Swap Game Slot 8"),
    // _trans("Swap Game Slot 9"),
    // _trans("Swap Game Slot 10"),
    // _trans("Swap Game Selected Slot"),
    ...
    // _trans("Reset Current Objective"),
